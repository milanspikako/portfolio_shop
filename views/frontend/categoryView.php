...
if ($status && count($productsFromCategory) > 0) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="/public/">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?php echo $openedRow['name']; ?></strong></div>
        </div>
    </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                    ...
                                    <a class="dropdown-item" href="?id=<?php echo $categoryId; ?>&order-by=title&order-direction=asc<?php if (isset($filters['priceRangeMin'])) {
    echo "&amp;MinRange =" . $filters['priceRangeMin'];
} ?><?php if (isset($filters['priceRangeMax'])) {
    echo "&maxRange = " . $filters['priceRangeMax'];
} ?>">Name, A to Z</a>
                                    <a class="dropdown-item" href="?id=<?php echo $categoryId; ?>&order-by=title&order-direction=desc<?php if (isset($filters['priceRangeMin'])) {
    echo "&amp;MinRange = " . $filters['priceRangeMin'];
} ?><?php if (isset($filters['priceRangeMax'])) {
    echo "&amp;MaxRange = " . $filters['priceRangeMax'];
} ?>">Name, Z to A</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="?id=<?php echo $categoryId; ?>&order-by=price&order-direction=asc<?php if (isset($filters['priceRangeMin'])) {
                    echo "&amp;MinRange = " . $filters['priceRangeMin'];
                } ?> <?php if (isset($filters['priceRangeMax'])) {
                    echo "&amp;MaxRange =" . $filters['priceRangeMax'];
                } ?>">Price, low to high</a>
                                    <a class="dropdown-item" href="?id=<?php echo $categoryId; ?>&order-by=price&order-direction=desc<?php if (isset($filters['priceRangeMin'])) {
                    echo "&amp;MinRange = " . $filters['priceRangeMin'];
                } ?><?php if (isset($filters['priceRangeMax'])) {
                    echo "&amp;MaxRange = " . $filters['priceRangeMax'];
                } ?>">Price, high to low</a>
        ...
        for ($i = 1; $i <= $numberOfPages; $i++) {
            if ($i == $currentPage) {
                ...
                ?>
                                                ...
                                                <li><a href="<?php if(isset($categoryId)) { echo "?id=" . $categoryId; } ?>&page=<?php echo $i; ?><?php if (isset($filters['priceRangeMin'])) {
                    echo "&minRange = " . $filters['priceRangeMin'];
                } ?><?php if (isset($filters['priceRangeMax'])) {
                    echo "&maxRange = " . $filters['priceRangeMax'];
