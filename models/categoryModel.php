 ...
 * @return array
 */
function getCategoriesForNavigation($connection, $categoryId = NULL, $filters = NULL) {
    $categories = [];
    ...
    try {
        ...
        if (!is_null($filters) && isset($filters['priceRangeMin']) && isset($filters['priceRangeMax']) && empty($categoryId)) {
        ...
        if (!is_null($filters) && isset($filters['order-by']) && isset($filters['order-direction'])) {

            $sqlQueryString .= " , " . $filters['order-by'] . " " . $filters['order-direction'];
        }
